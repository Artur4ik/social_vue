...
<template>
<div>
<input type="checkbox" class="checkbox" :id="`like-for-post-${post_id}`" :checked="isLiked" />
<label :for="`like-for-post-${post_id}`">
...
.checkbox:checked + label svg .heart {
  transform: scale(0.2);
  fill: #E2264D;
  animation: animateHeart 1s linear forwards 0.25s;
}
